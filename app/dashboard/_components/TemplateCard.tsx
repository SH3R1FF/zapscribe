...
function TemplateCard(item:Template) {
  return (
    <Link href={'/dashboard/content/' + item?.slug} className={''}>
      ...
      <div className='p-5 shadow-md rounded-xl  bg-neutral-900 border border-zinc-800 flex flex-col gap-3 cursor-pointer hover:scale-105 duration-300 hover:bg-[#202020]'>
